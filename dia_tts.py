...
def main() -> None:
    ...
    parser.add_argument("--max-tokens", type=int, default=3072, metavar="N", dest="max_tokens", help="Max audio tokens to generate (default: 3072, ~35s). Hard cap: 3072 (decoder positional limit).")
